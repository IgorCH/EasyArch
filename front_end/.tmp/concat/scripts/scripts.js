angular.module('theme.core.main_controller', ['theme.core.services'])
  .controller('MainController', ['$scope', '$theme', '$timeout', 'progressLoader', '$location',
    ...
    $scope.layoutPageTransitionStyleList = ['bounce', 'flash', 'pulse', 'bounceIn', 'bounceInDown', 'bounceInLeft',
      ...
      'rotateInDownRight', 'rotateInUpLeft', 'rotateInUpRight', 'rollIn', 'zoomIn', 'zoomInDown', 'zoomInLeft', 'zoomInRight', 'zoomInUp'
    ];
    ...
    $scope.chatters = [
      {id: 0, status: 'online', avatar: 'potter.png', name: 'Jeremy Potter'},
      {id: 1, status: 'online', avatar: 'tennant.png', name: 'David Tennant'},
      {id: 2, status: 'online', avatar: 'johansson.png', name: 'Anna Johansson'},
      {id: 3, status: 'busy', avatar: 'jackson.png', name: 'Eric Jackson'},
      {id: 4, status: 'online', avatar: 'jobs.png', name: 'Howard Jobs'},
      {id: 5, status: 'online', avatar: 'potter.png', name: 'Jeremy Potter'},
      {id: 6, status: 'away', avatar: 'tennant.png', name: 'David Tennant'},
      {id: 7, status: 'away', avatar: 'johansson.png', name: 'Anna Johansson'},
      {id: 8, status: 'online', avatar: 'jackson.png', name: 'Eric Jackson'},
      {id: 9, status: 'online', avatar: 'jobs.png', name: 'Howard Jobs'}
    ];
...
angular
  .module('theme.core.service_controller', ['theme.core.services'])
  .controller('ServiceController', ['$scope', '$theme', 'EasyArchDataSource',
                          function($scope, $theme, EasyArchDataSource) {
    'use strict';
...
angular
  .module('theme.core.portfolio_controller', ['theme.core.services'])
  .controller('PortfolioController', ['$scope', '$theme', 'EasyArchDataSource',
                          function($scope, $theme, EasyArchDataSource) {
    'use strict';
...
angular
  .module('theme.core.help_controller', ['theme.core.services'])
  .controller('HelpController', ['$scope', '$theme', 'EasyArchDataSource',
                          function($scope, $theme, EasyArchDataSource) {
    'use strict';
...
angular
  .module('theme.core.contacts_controller', ['theme.core.services'])
  .controller('ContactsController', ['$scope', '$theme', 'EasyArchDataSource',
                          function($scope, $theme, EasyArchDataSource) {
    'use strict';
...
angular
  ...
  .controller('ProjectsController', ['$scope', '$theme', '$routeParams', 'EasyArchDataSource',
    ...
    $scope.onDeleteProject = function(project) {
        EasyArchDataSource.deleteProject({projectId: project._id}, function(res) {
...
angular
  ...
  .controller('ProjectController', ['$scope', '$theme', 'EasyArchDataSource', function($scope, $theme, EasyArchDataSource) {
    'use strict';
...
angular
  .module('theme.core.tasks_controller', ['theme.core.services'])
  .controller('TasksController', ['$scope', '$theme', 'EasyArchDataSource',
                          function($scope, $theme, EasyArchDataSource) {
    'use strict';
...
angular
  ...
  .controller('NewTaskController', ['$scope', '$theme', 'EasyArchDataSource',
                          function($scope, $theme, EasyArchDataSource) {
    'use strict';
...
angular
  .module('theme.core.models_controller', ['theme.core.services'])
  .controller('ModelsController', ['$scope', '$theme', 'EasyArchDataSource',
                          function($scope, $theme, EasyArchDataSource) {
    'use strict';
...
angular
  .module('theme.core.scenes_controller', ['theme.core.services'])
  .controller('ScenesController', ['$scope', '$theme', 'EasyArchDataSource',
                          function($scope, $theme, EasyArchDataSource) {
    'use strict';
