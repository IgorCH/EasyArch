...
angular.module('theme.core.cr_numeric', []).directive('crNumeric', [function () {
  'use strict';
...
angular.module('theme.core.templates', []).run(['$templateCache', function ($templateCache) {
  ...
  $templateCache.put('templates/nav_renderer_horizontal.html',
    ...
    "    <li ng-repeat=\"item in item.children | orderBy:'+priority'\"\n" +
  ...
  $templateCache.put('templates/nav_renderer.html',
    ...
    "</div>\n" +
    "\n" +
    "<div class=\"line-separator\" ng-if=\"item.lineSeparator\">\n" +
    "</div>\n" +
    "\n" +
    "<a ng-if=\"!item.separator && !item.lineSeparator\" ng-click=\"select(item)\" ng-href=\"{{item.url}}\">\n" +
...
angular
  .module('theme.core.services')
  .service('$theme', ['$rootScope', 'EnquireService', '$document', 'DADataSource', '$localStorage', function ($rootScope, EnquireService, $document, DADataSource, $localStorage) {
    'use strict';
    ...
    var DEFAULT_SETTINGS = {
      ...
      sidebarThemeClass: "sidebar-inverse",
      showChatBox: false,
